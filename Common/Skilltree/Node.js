  ...
  export default class Node {
      ...
      static DrawRequisits = () => {
          Node.RegisteredNodes.forEach(n => {
              ...
              ChatManager[
                  "void DrawColorCodedStringShadow(SpriteBatch spriteBatch, SpriteFont font, string text, Vector2 position, Color baseColor, float rotation, Vector2 origin, Vector2 baseScale, float maxWidth, float spread)"
              ](
                  Main.spriteBatch,
                  font,
                  `${n.requirement.level}`,
